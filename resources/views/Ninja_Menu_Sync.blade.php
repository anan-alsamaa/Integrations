...
<div class="container2">
    <div class="row text-center">
        <div class="col-xs-12">
            <img src="{{ asset('assets/img/ninja.png') }}" alt="ToYou Logo" class="top-image top-image2" id="logoImage">
        </div>
    </div>
    ...
    <div class="row text-center">
        ...
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
            ...
            <a href="#" class="sync-sara-button" data-brand-id="1004" style="margin-top: 10px; display: inline-block;">
                <button>Sync SARA</button>
            </a>
        </div>
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
...
<script>
    $(document).ready(function() {
        ...
        $('#syncBranchForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route("sync.menu-branch-ninja") }}',
                type: 'POST',
                data: {
                    brand_id: brandId,
                    pos_key: posKey
        ...
        $('.sync-sara-button').on('click', function(event) {
            ...
            $.ajax({
                url: '{{ route("sync.menu-sara-ninja") }}',
                method: 'POST',
                data: { brand_id: brandId },
                success: function(response) {
                    $('#responseContent').text(JSON.stringify(response, null, 2));
