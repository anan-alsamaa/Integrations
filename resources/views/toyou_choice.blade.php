...
<div class="container2">
    <div class="row text-center">
        ...
        <div class="col-xs-12">
            <img src="{{ asset('assets/img/toyou.png') }}" alt="ToYou Logo" class="top-image" id="logoImage">
        </div>
    </div>

    <div class="row text-center">
        <div class="col-xs-12 col-sm-6 d-flex justify-content-center align-items-center">
            <a style="color: #4d555e87" href="{{ url('/toyou-menu-sync') }}">
        ...
        <div class="col-xs-12 col-sm-6 d-flex justify-content-center align-items-center">
            <a style="color: #4d555e87" href="{{ url('/toyou-pos-mapping') }}">
