...
<div class="container2">
    ...
    <div class="row text-center">
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
            ...
            <a href="#" class="sync-sara-button" data-brand-id="1" data-brand-reference-id="1" style="margin-top: 10px; display: inline-block;">
        ...
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
            ...
            <a href="#" class="sync-sara-button" data-brand-id="2" data-brand-reference-id="1004" style="margin-top: 10px; display: inline-block;">
               <button>Sync SARA</button>
            </a>
        </div>
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
            ...
            <a href="#" class="sync-sara-button" data-brand-id="2" data-brand-reference-id="2" style="margin-top: 10px; display: inline-block;">
                <button>Sync SARA</button>
            </a>
        </div>
        <div class="col-xs-12 col-sm-3 d-flex justify-content-center align-items-center">
            ...
            <a href="#" class="sync-sara-button" data-brand-id="1" data-brand-reference-id="3" style="margin-top: 10px; display: inline-block;">
                <button>Sync SARA</button>
            </a>
        </div>
    </div>
